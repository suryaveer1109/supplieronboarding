...
export class PortfolioListComponent implements OnInit {
  ...
  constructor(private _httpService:HttpService,private _snackBar: MatSnackBar,private data: DataService) { };
  ...
  searchData(searchType){
    ...
    .subscribe(data=>{this.portfolios=data?.data; this.search.text=""},
